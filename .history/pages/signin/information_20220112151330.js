...
import styles from '../../styles/Signin/Information.module.css'
                    ...
                    <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <div className="mb-4">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <a className="inline-block align-baseline font-regular text-sm text-blue-500 hover:text-blue-800" href="changepassword">
                                Change
                                </a>
                            </div>
