                        ...
                        <div className="mb-4">
                            ...
                            <div className="block text-gray-700 text-sm font-bold mb-2"> 
                                <div className="auth-form__group">
                                    <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="Old_Password" type="Password" placeholder="Password (6 digits ai least)"/>
                                </div>
                            </div>

                            <div className="block text-gray-700 text-sm font-bold mb-2"> 
                                <div className="auth-form__group">
                                    <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="New_Password" type="Password" placeholder="Password (6 digits ai least)"/>
                                </div>
                            </div>
